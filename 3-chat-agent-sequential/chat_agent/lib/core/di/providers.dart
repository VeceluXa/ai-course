...
import '../../features/settings/data/repositories/system_prompt_repository_impl.dart';
import '../../features/settings/domain/repositories/api_key_repository.dart';
import '../../features/settings/domain/repositories/system_prompt_repository.dart';
import '../../features/settings/domain/usecases/delete_api_key.dart';
import '../../features/settings/domain/usecases/delete_system_prompt.dart';
import '../../features/settings/domain/usecases/get_api_key.dart';
import '../../features/settings/domain/usecases/get_system_prompt.dart';
import '../../features/settings/domain/usecases/save_api_key.dart';
import '../../features/settings/domain/usecases/save_system_prompt.dart';
...
final systemPromptRepositoryProvider = Provider<SystemPromptRepository>((ref) {
  return SystemPromptRepositoryImpl(ref.read(prefsStoreProvider));
});
...
final getSystemPromptProvider = Provider<GetSystemPrompt>((ref) {
  return GetSystemPrompt(ref.read(systemPromptRepositoryProvider));
});
...
final saveSystemPromptProvider = Provider<SaveSystemPrompt>((ref) {
  return SaveSystemPrompt(ref.read(systemPromptRepositoryProvider));
});
...
final deleteSystemPromptProvider = Provider<DeleteSystemPrompt>((ref) {
  return DeleteSystemPrompt(ref.read(systemPromptRepositoryProvider));
});
